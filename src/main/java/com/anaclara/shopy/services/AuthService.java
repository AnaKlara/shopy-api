...
public class AuthService {
	...
	private char randomChar() {
		...
		if (opt == 0) { // gera um digito
			return (char) (rand.nextInt(10) + 48); // valor equivalente en unicode
		}
		else if (opt == 1) { // gera letra maiuscula
			return (char) (rand.nextInt(26) + 65); // valor equivalente en unicode
		}
		else { // gera letra minuscula
			return (char) (rand.nextInt(26) + 97); // valor equivalente en unicode
		}
	}
}
