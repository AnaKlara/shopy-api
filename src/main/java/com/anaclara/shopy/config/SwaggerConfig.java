package com.anaclara.shopy.config;
...
public class SwaggerConfig{ 
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
						...
						.select()
						//.apis(RequestHandlerSelectors.any()) // quais o pacotes o swagger vai vigiar para gerar a doc
						.apis(RequestHandlerSelectors.basePackage("com.anaclara.shopy.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				"API e-commerce Shopy",
				"Esta API foi desenvolvida com o intuito de servir como e-commerce.",
				"Versão 1.0",
				"https://www.gnu.org/licenses/gpl-3.0.html",
				new Contact("Ana Clara Correa da Silva", "https://anaklara.github.io/", "claracorreadasilva@gmail.com"),
